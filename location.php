...
<?php 
$result = mysqli_query($conn, "SELECT * FROM location ORDER BY name DESC");
?>
    ...
    <table class="table table-bordered">
      ...
      <tbody>
        ...
        while ($res = mysqli_fetch_array($result)) {
          echo "<tr>";
          echo "<td style='display: none;'>" . $res['id'] . "</td>";
          echo "<td>" . $res['name'] . "</td>";
          echo "<td>" . $res['cost'] . "</td>";
           echo "<td> <button type='button' data-toggle='modal' data-target='#editmodal' class='btn btn-success editbtn'> <i class='bx bx-edit-alt' ></i> </button>   <a class='btn btn-danger ' href=\"php/delete-location.php?id=$res[id]\" onClick=\"return confirm('Are you sure you want to delete?')\"><i class='bx bx-trash' ></i></a></td>";
        }
        ?>
